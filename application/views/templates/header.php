...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url(); ?>assets/sbadmin/img/logobps.png">

    <title>Simitra <?= $title ?></title>
    ...
    <link href="<?= base_url(); ?>assets/sbadmin/css/sb-admin-3.css" rel="stylesheet">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>home">
                <div class="sidebar-brand-icon ">
                    <img src="<?= base_url(); ?>assets/sbadmin/img/logobps.png" width="50">
                </div>
                <div class="sidebar-brand-text mx-3 ">SIM-MITRA</div>
